...
<nav class="navbar navbar-default navbar-fixed-top bs-docs-nav" role="navigation">
 ...
 <ul class="nav navbar-nav" id="Iconsnav"> 
      <li class="menuhighlight request-icon " id="REQUEST"><a class="" href="../support/SupportDetails.do"> <span class="menutexalign">Request</span></a></li>
...
<div class="modal fade" id="contactSupportModal" tabindex="-1" role="dialog"  aria-hidden="true">
  <div class="modal-dialog" style="max-width: 50% !important; width: auto !important;">
    <div class="modal-content modal-content-width">
      <div class="modal-header chartsModalHeader">
        ...
        <h4 class="modal-title" ">Expedia Contact Support</h4>
      </div>
